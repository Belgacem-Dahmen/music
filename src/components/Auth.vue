        ...
        <div class="py-4 text-left px-6">
          ...
          <Vee-form v-show="tab === 'register'" :validation-schema="schema" @submit="register">
            ...
            <div class="mb-3">
              ...
              />
              <ErrorMessage class="text-red-600 pt-2" name="name" />
            </div>
            <!-- Email -->
            <div class="mb-3">
              <label class="inline-block mb-2">Email</label>
              <Vee-field
                ...
                placeholder="Enter Email"
              />
              <ErrorMessage class="text-red-600 pt-2" name="email" />
            </div>
            <!-- Age -->
            <div class="mb-3">
              ...
              <Vee-field
                ...
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition duration-500 focus:outline-none focus:border-black rounded"
              />
              <ErrorMessage class="text-red-600 pt-2" name="age" />
            </div>
            <!-- Password -->
            <div class="mb-3">
              <label class="inline-block mb-2">Password</label>
              <Vee-field
                ...
                placeholder="Password"
              />
              <ErrorMessage class="text-red-600 pt-2" name="password" />
            </div>
            <!-- Confirm Password -->
            <div class="mb-3">
              ...
              />
              <ErrorMessage class="text-red-600 pt-2" name="confirm_password" />
            </div>
